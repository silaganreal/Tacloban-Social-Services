...
<div class="content-wrapper">
    ...
    {{-- modal upload new logs end --}}

    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-auto">
                    <h1 class="m-0">Search Clients</h1>
                </div>
                {{-- <div class="col-auto">
                    <a href="{{ url('/clients') }}" class="btn btn-sm btn-secondary">Back</a>
                </div> --}}
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-striped dtable2 display" style="width:100%">
                            <thead>
                                <tr>
